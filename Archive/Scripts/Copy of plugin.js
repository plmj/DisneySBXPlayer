    ...
    appendPlayer: function (data, mediaItem, performHDCPCheck) {
        ...
        jQuery.ajax({
            ...
            if (nativePlayback) {
                ...
                var mediaPlayerController = new ascendon.MediaPlayerController(video, playerSettings);

                var uiController = new ascendon.UIController(mediaPlayerController, {
                ...
                uiController.initialize();
								window.ascendon.htmlplayer.uiController = uiController;
                ...
                if (performHDCPCheck) {
                    try {
                        ...
                        if (null !== htmlPlayerSettings) {
                            mediaPlayerController.checkHDCP(htmlPlayerSettings.hdcpTestFile, function (hdcpSupported) {
                                $.cd.get_loginInfo().set_outputProtectionSupported(hdcpSupported ? 1 : 2);
                            });
                        } else {
                    ...
                    mediaPlayerController.addEventListener('playererror', function () {
                        $.cd.hideBlocker();
                    });

                    mediaPlayerController.addEventListener('failedloadingcontrols', function () {
                        $.cd.hideBlocker();
                    });
