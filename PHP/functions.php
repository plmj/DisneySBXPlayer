<?php
	...
	if(isset($_POST['action']) && !empty($_POST['action'])) {
		...
		if(isset($_POST['deliveryCapability'])){
			 $deliveryCapability = $_POST['deliveryCapability'];
		}
		...
		switch($action) {
			...
			break;
			case 'viewContentWithId':
				viewContentWithId($sessionId, $planId, $productId, $deliveryCapability, $mediaId);
			break;
		}
	}
...
function createStandardProduct($productName,$productExternalReference,$CID){
	...
	function viewContentWithId($sessionId, $planId, $productId, $deliveryCapability, $mediaId){
		$url = ViewContentEndpoint;
		$viewContentRequest = array( 
		...
		$content = json_encode($viewContentRequest);
		//var_dump($content);
		$curl = curl_init($url);
		curl_setopt($curl, CURLOPT_SSL_VERIFYHOST,"0");
    curl_setopt($curl, CURLOPT_SSL_VERIFYPEER,"0");
