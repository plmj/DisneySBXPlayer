...
var defaultsettings = {	
	...
	htmlplayer: {
      ...
      callUpdateContentProgressOnUnload: true,
      callUpdateContentProgressOnStop: true
  },
	detail: {
		browser: {
			minimumIEVersion: 8,
						...
						method: function (result) {									
							var _createPlayerInitParams = function (dataObj) {
								...
								if (null != dataObj.data.initJson) {
									...
									if (tempJson.ClosedCaptions != null && tempJson.ClosedCaptions.ClosedCaptionSettings == null){
...
// Go to compact mode: StorefrontInternalAPI._extension.go_compact();
// HTML5 : ascendon.htmlplayer.uiController.toggleCompact();
